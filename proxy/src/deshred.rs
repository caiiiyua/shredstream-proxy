...
pub fn reconstruct_shreds_to_entries<'a>(
    shred: solana_ledger::shred::Shred,
    ...
    if let Ok(shred) = Shred::try_from(shred) {
        ...
        if all_shreds.len() > SLOT_LOOKBACK as usize && highest_slot_seen > SLOT_LOOKBACK {
